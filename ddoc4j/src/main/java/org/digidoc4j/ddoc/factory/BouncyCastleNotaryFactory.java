...
public class BouncyCastleNotaryFactory implements NotaryFactory
{
     ...
     * @returns Notary object
     */
    public Notary getConfirmation(org.digidoc4j.ddoc.Signature sig, byte[] nonce,
     ...
     *   X509Certificate notaryCert, String notId, String ocspUrl, String httpFrom, String format, String formatVer)
     */
    public Notary getConfirmation(org.digidoc4j.ddoc.Signature sig,
                                  X509Certificate signersCert, X509Certificate caCert)
            throws DigiDocException
    {
        Notary not = null;
        ...
        try {
            ...
            if(notaryCert == null && sig != null && sig.getUnsignedProperties() != null) {
                ...
                if(resp != null && resp.getResponseObject() != null) {
                    ...
                    CertID cid = new CertID(sig, notaryCert, CertID.CERTID_TYPE_RESPONDER);
                    sig.addCertID(cid);
     ...
     *   X509Certificate notaryCert, String notId, String ocspUrl, String httpFrom, String format, String formatVer)
     */
    public Notary getConfirmation(org.digidoc4j.ddoc.Signature sig, X509Certificate signersCert)
            throws DigiDocException
    {
        String notId = sig.getId().replace('S', 'N');
     ...
     * @returns Notary object
     */
    private Notary parseAndVerifyResponse(org.digidoc4j.ddoc.Signature sig, OCSPResp resp,
     ...
     * @returns Notary object
     */
    private Notary parseAndVerifyResponse(org.digidoc4j.ddoc.Signature sig, String notId,
     ...
     */
    private void checkCertStatus(org.digidoc4j.ddoc.Signature sig, BasicOCSPResp basResp)
            throws DigiDocException
    {
