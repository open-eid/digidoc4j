...
public class TestSigningUtil {
  ...
  public static X509Certificate getSigningCert() {
    return TestSigningUtil.getSigningCert(TEST_PKI_CONTAINER, TEST_PKI_CONTAINER_PASSWORD);
  }
  ...
  public static X509Certificate getSigningCertECC() {
    ...
    return TestSigningUtil.getSigningCert(TEST_ECC_PKI_CONTAINER, TEST_ECC_PKI_CONTAINER_PASSWORD, token.getAlias());
  }

  public static X509Certificate getSigningCert(String pkiContainer, String pkiContainerPassword) {
    return TestSigningUtil.getSigningCert(pkiContainer, pkiContainerPassword, "1");
  }
