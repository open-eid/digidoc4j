...
public class DDocFacadeTest {
  ...
  public void testGetDataFileSize() {
    DDocFacade container = openDocFacade("src/test/resources/testFiles/valid-containers/ddoc_for_testing.ddoc");
  ...
  public void testCanAddTwoDataFilesWithSameName() throws Exception {
    ...
    dDocContainer.addDataFile("src/test/resources/testFiles/helper-files/test.txt", TEXT_MIME_TYPE);
    dDocContainer.addDataFile("src/test/resources/testFiles/helper-files/test.txt", TEXT_MIME_TYPE);
    dDocContainer.save("src/test/resources/testFiles/tmp/test_ddoc_file.ddoc");
    Container container = ContainerOpener.open("src/test/resources/testFiles/tmp/test_ddoc_file.ddoc");
  ...
  public void testGetFileId() {
    DDocFacade container = new DDocFacade();
    container.addDataFile("src/test/resources/testFiles/helper-files/test.txt", TEXT_MIME_TYPE);
    container.addDataFile("src/test/resources/testFiles/helper-files/test.txt", TEXT_MIME_TYPE);
    List<org.digidoc4j.DataFile> dataFiles = container.getDataFiles();
  ...
  public void testAddEmptyFile() throws Exception {
    ...
    dDocContainer.save("src/test/resources/testFiles/tmp/test_empty.ddoc");
    Container container = ContainerOpener.open("src/test/resources/testFiles/tmp/test_empty.ddoc");
    List<org.digidoc4j.DataFile> dataFiles = container.getDataFiles();
  ...
  public void getDataFileByIndex() {
    DDocFacade container = new DDocFacade();
    container.addDataFile("src/test/resources/testFiles/helper-files/test.txt", TEXT_MIME_TYPE);
    container.addDataFile("src/test/resources/testFiles/helper-files/test.xml", TEXT_MIME_TYPE);
  ...
  public void testAddDataFileThrowsException() throws Exception {
    ...
    DDocFacade container = new DDocFacade(ddoc);
    container.addDataFile("src/test/resources/testFiles/helper-files/test.txt", "");
  }
  ...
  public void setsSignatureId() throws Exception {
    ...
    container.setSignatureParameters(signatureParameters);
    container.sign(PKCS12_SIGNER);
    container.save("src/test/resources/testFiles/tmp/testSetsSignatureId.ddoc");

    container = openDocFacade("src/test/resources/testFiles/tmp/testSetsSignatureId.ddoc");
  ...
  public void setsDefaultSignatureId() throws Exception {
    ...
    container.sign(PKCS12_SIGNER);
    container.sign(PKCS12_SIGNER);
    container.save("src/test/resources/testFiles/tmp/testSetsDefaultSignatureId.ddoc");

    container = openDocFacade("src/test/resources/testFiles/tmp/testSetsDefaultSignatureId.ddoc");
  ...
  public void extendToTM() throws Exception {
    ...
    container.setSignatureProfile(B_BES);
    container.sign(PKCS12_SIGNER);
    container.save("src/test/resources/testFiles/tmp/testAddConfirmation.ddoc");
    container = open("src/test/resources/testFiles/tmp/testAddConfirmation.ddoc");
    assertNull(container.getSignature(0).getOCSPCertificate());

    container.extendTo(LT_TM);
    container.save("src/test/resources/testFiles/tmp/testAddedConfirmation.ddoc");
    container = open("src/test/resources/testFiles/tmp/testAddedConfirmation.ddoc");
  ...
  public void twoStepSigning() {
    ...
    container.save("src/test/resources/testFiles/tmp/test.ddoc");

    container = ContainerOpener.open("src/test/resources/testFiles/tmp/test.ddoc");
  ...
  public void signRawWithLT_TMSignatureProfileAddsOCSP() {
    String dDocFileName = "src/test/resources/testFiles/tmp/testOCSPAddedWithRawSignature.ddoc";
  ...
  public void signRawWithNoSignatureProfileDoesNotAddOCSP() {
    String dDocFileName = "src/test/resources/testFiles/tmp/testOCSPNotAddedWithRawSignatureWhenNoProfile.ddoc";
  ...
  public void configManagerShouldBeInitializedOnlyOnce() throws Exception {
    ...
    assertTrue(ConfigManagerInitializer.isConfigManagerInitialized());
    assertEquals(1, ConfigManagerInitializerSpy.configManagerCallCount);
    String path = "src/test/resources/testFiles/valid-containers/ddoc_for_testing.ddoc";
  ...
  public void openingDDoc_withoutCAConfiguration_shouldThrowException() throws Exception {
    ...
    ContainerOpener.open("src/test/resources/testFiles/valid-containers/ddoc_for_testing.ddoc", configuration);
  }
