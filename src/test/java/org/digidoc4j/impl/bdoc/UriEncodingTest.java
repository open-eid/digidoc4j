...
public class UriEncodingTest extends DigiDoc4JTestHelper {
    ...
    public void validatePartialEncoding_shouldBeValid() throws Exception {
        Container container = ContainerBuilder.
            aContainer().
            fromExistingFile("src/test/resources/testFiles/valid-containers/et10_0123456789!#$%&'()+,-. ;=@[]_`}- et_EE_utf8.zip-d_ec.bdoc").
            build();
    ...
    public void validateContainer_withWhitespaceEncodedAsPlus_shouldBeValid() throws Exception {
        Container container = ContainerBuilder.
            aContainer().
            fromExistingFile("src/test/resources/testFiles/valid-containers/M1n1 Testäöüõ!.txt-TS-d4j.bdoc").
            build();
        ValidationResult result = container.validate();
        assertTrue(result.isValid());
    }
