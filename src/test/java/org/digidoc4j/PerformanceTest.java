...
public class PerformanceTest {
  ...
  public void setUp() throws Exception {
    ...
    container = openContainer("src/test/resources/testFiles/valid-containers/valid-bdoc-tm.bdoc", configuration);
    jDigidocContainer = openContainerWithJdigidoc("src/test/resources/testFiles/valid-containers/valid-bdoc-tm.bdoc");
  }

  @Test
  @PerfTest(invocations = 1000, threads = 1)
  public void validateTestBDocTmSignatures() throws Exception {
    assertContainerValid("src/test/resources/testFiles/valid-containers/valid-bdoc-tm.bdoc");
  }

  @Test
  @PerfTest(invocations = 1000, threads = 1)
  public void validateTestBDocTmWithJDigidoc() throws Exception {
    assertContainerValidWithJDigiDoc("src/test/resources/testFiles/valid-containers/valid-bdoc-tm.bdoc");
  }
  ...
  public void validateTestBDocTmSignaturesInThreads() throws Exception {
    assertContainerValid("src/test/resources/testFiles/valid-containers/valid-bdoc-tm.bdoc");
    assertContainerValid("src/test/resources/testFiles/valid-containers/IB-4185_bdoc21_TM_mimetype_with_BOM_TEST.bdoc");
    validateInvalidContainer("src/test/resources/testFiles/invalid-containers/bdoc-tm-ocsp-revoked.bdoc", "The past signature validation is not conclusive!");
  }
  ...
  public void validateTestBDocTmWithJDigidocInThreads() throws Exception {
    assertContainerValidWithJDigiDoc("src/test/resources/testFiles/valid-containers/valid-bdoc-tm.bdoc");
    assertContainerValidWithJDigiDoc("src/test/resources/testFiles/valid-containers/IB-4185_bdoc21_TM_mimetype_with_BOM_TEST.bdoc");
    validateInvalidContainerWithJDigidoc("src/test/resources/testFiles/invalid-containers/bdoc-tm-ocsp-revoked.bdoc", "ERROR: 91 - Certificate has been revoked!");
  }

  @Test
  @PerfTest(invocations = 1000, threads = 1)
  public void validateLargeContainer() throws Exception {
    assertContainerValid("src/test/resources/testFiles/valid-containers/bdoc-tm-with-large-data-file.bdoc");
  }

  @Test
  @PerfTest(invocations = 1000, threads = 1)
  public void validateLargeContainerWithJDigidoc() throws Exception {
    assertContainerValidWithJDigiDoc("src/test/resources/testFiles/valid-containers/bdoc-tm-with-large-data-file.bdoc");
  }

  @Test
  @PerfTest(invocations = 1, threads = 1)
  public void validateBDocWith1000Signatures() throws Exception {
    assertContainerValid("src/test/resources/testFiles/valid-containers/bdoc-tm-1000-signatures.bdoc");
  }

  @Test
  @PerfTest(invocations = 1, threads = 1)
  public void validateBDocWith1000SignaturesWithJDigidoc() throws Exception {
    assertContainerValidWithJDigiDoc("src/test/resources/testFiles/valid-containers/bdoc-tm-1000-signatures.bdoc");
  }

  @Test
  @PerfTest(invocations = 1000, threads = 1)
  public void openBDocTmContainerDetails() throws Exception {
    Container container = openContainer("src/test/resources/testFiles/valid-containers/valid-bdoc-tm.bdoc", configuration);
  ...
  public void openBDocTmContainerDetailsWithJdigidoc() throws Exception {
    SignedDoc container = openContainerWithJdigidoc("src/test/resources/testFiles/valid-containers/valid-bdoc-tm.bdoc");
  ...
  private void signContainer(Container container, SignatureProfile signatureProfile) {
    SignatureToken signatureToken = new PKCS12SignatureToken("src/test/resources/testFiles/p12/signout.p12", "test".toCharArray());
