 ...
 */
public class DD4JBDocContainer extends Container {

  final Logger logger = LoggerFactory.getLogger(DD4JBDocContainer.class);
   ...
   */
  public DD4JBDocContainer(String path) {
    this();
