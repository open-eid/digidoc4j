...
class ExtensionOrderUtilsTest {

  @Test
  void getExtensionOrder_MinToMaxProfile_FullChainReturned() {
  ...
  @Test
  void getExtensionOrder_TToLT_PartialChainReturned() {
  ...
  @Test
  void getExtensionOrder_LTAToLTA_ChainOfOneReturned() {
  ...
  @Test
  void getExtensionOrder_InvalidOrder_IllegalArgumentException() {
  ...
  @Test
  void getExtensionOrder_UnsupportedSourceProfile_IllegalArgumentException() {
  ...
  @Test
  void getExtensionOrder_UnsupportedTargetProfile_IllegalArgumentException() {
