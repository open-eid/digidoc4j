...
public class AsicESignatureOpenerTest extends AsicXadesSignatureOpenerTest {

  @Override
  protected AsicXadesSignatureOpener signatureOpener() {
    return new AsicESignatureOpener(configuration);
  }

  @Override
  protected void assertSignatureType(Signature signature) {
    assertThat(signature, instanceOf(AsicESignature.class));
  }
